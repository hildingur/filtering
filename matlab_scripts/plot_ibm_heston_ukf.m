...
title(strcat('IBM Heston UKF' ,' last 100 \omega: \mu = ', num2str(mean), ' \sigma^{2} = ', num2str(variance)));
...
title(strcat('IBM Heston UKF' ,' last 100 \theta: \mu = ', num2str(mean), ' \sigma^{2} = ', num2str(variance)));
...
title(strcat('IBM Heston UKF' ,' last 100 \xi: \mu = ', num2str(mean), ' \sigma^{2} = ', num2str(variance)));
...
title(strcat('IBM Heston UKF' ,' last 100 \rho: \mu = ', num2str(mean), ' \sigma^{2} = ', num2str(variance)));
